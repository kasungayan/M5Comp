...
# Function to calculate the forecasts for a given cluster of series by training a pooled regression model
# Parameters
...
calculate_forecasts <- function(cluster_data, cluster_series_numbers, lag) {
  ...
  cluster_forecasts <- fit_clustering_model(fitting_data = embedded_series, final_lags, cluster_series_numbers, horizon, series_means)
  cluster_forecasts
}


# Fit and forecast from a pooled regression model for clustered data
# Parameters
...
fit_clustering_model <- function(fitting_data, final_lags, cluster_series_numbers, horizon, series_means) {
...
# Obtaining pooled regression forecasts for all clusters
